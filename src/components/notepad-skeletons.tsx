...
export function NotepadCardSkeleton() {
  return (
    <div className="flex min-h-[220px] flex-col rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
  ...
  return (
    <div className="mx-auto w-full max-w-6xl flex-1 px-5 py-10 sm:px-6">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex min-h-[220px] items-center justify-center rounded-2xl border-2 border-dashed border-blue-100 bg-white p-6 dark:border-slate-700 dark:bg-slate-900">
